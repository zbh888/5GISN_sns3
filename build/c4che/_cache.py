...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-std=c++11', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['naming', 'udp', 'wireless', 'error-model', 'realtime', 'traffic-control', 'tcp', 'tutorial', 'stats', 'ipv6', 'socket', 'energy', 'matrix-topology', 'udp-client-server', 'routing']
...
NS3_CONTRIBUTED_MODULES = ['ns3-magister-stats', 'ns3-satellite', 'ns3-traffic']
NS3_ENABLED_CONTRIBUTED_MODULES = ['ns3-magister-stats', 'ns3-satellite', 'ns3-traffic']
...
NS3_EXECUTABLE_PATH = ['/home/b327zhan/Documents/ns-3.29/build/src/fd-net-device', '/home/b327zhan/Documents/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/11', '/home/b327zhan/Documents/ns-3.29/build/lib']
...
cfg_files = ['/home/b327zhan/Documents/ns-3.29/build/ns3/config-store-config.h', '/home/b327zhan/Documents/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
